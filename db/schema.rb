...
ActiveRecord::Schema.define(:version => 20140609102051) do
  ...
  create_table "moneys", :force => true do |t|
    t.integer  "game_id"
    t.integer  "total"
    t.integer  "remaining"
    t.datetime "created_at", :null => false
  ...
  add_index "user_scores", ["user_id", "score_id", "game_id"], :name => "index_user_scores_on_user_id_and_score_id_and_game_id", :unique => true
